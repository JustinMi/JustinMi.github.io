...
{% include image.html url="/assets/images/endclothing.png" description="A webstore that offers differing versions of its website depending on the country it is shipping to" %}
