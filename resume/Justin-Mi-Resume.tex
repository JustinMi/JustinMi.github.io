    ...
    \begin{topic}{Experience}
        ...
        \end{event}
            \begin{itemize}
                ...
                % \item PCARI, Django, internalization/localization, SQL transition, works with bad internet connections, survey and data visualization tool for disaster preparedness
            \end{itemize}
        \vspace*{0.1in}
