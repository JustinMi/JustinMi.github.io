...
\begin{document}
    ...
    \begin{topic}{\textbf{Experience}}
        ...
        \begin{event}
            ...
            \emph{Software Engineering Intern} & \emph{May 2018 - Present} \\
        \end{event}
            \begin{itemize}
                \item Converted Stripe's global Instant Payouts infrastructure gateway to a new vendor
                \item Achieved 100\% routing redundancy for entire \$3B+ annualized global Instant Payouts volume
                \item Achieved nearly 100\% uptime and stability for clients like Lyft, Instacart, Postmates, and Care.com
                ...
                \item Enabled Stripe to more quickly scale Instant Payouts into international regions
            \end{itemize}
